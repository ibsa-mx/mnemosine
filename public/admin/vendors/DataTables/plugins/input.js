...
(function ($) {
	...
	$.fn.dataTableExt.oPagination.input = {
		'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
			...
			var info = language.info || ' Pag. _INPUT_ de _TOTAL_ ';

            nFirst.href = "javascript:;";
            nPrevious.href = "javascript:;";
            nNext.href = "javascript:;";
            nLast.href = "javascript:;";
			nFirst.innerHTML = '<i class="fas fa-fast-backward"></i>';
			nPrevious.innerHTML = '<i class="fas fa-step-backward"></i>';
			nNext.innerHTML = '<i class="fas fa-step-forward"></i>';
			nLast.innerHTML = '<i class="fas fa-fast-forward"></i>';

			nFirst.className = firstClassName + ' btn btn-outline-primary d-inline mr-1 ' + classes.sPageButton;
			nPrevious.className = previousClassName + ' btn btn-outline-primary d-inline ' + classes.sPageButton;
			nNext.className = nextClassName + ' btn btn-outline-primary mr-1 d-inline ' + classes.sPageButton;
			nLast.className = lastClassName + ' btn btn-outline-primary d-inline ' + classes.sPageButton;
